(define generic-on-key '("<Shift> " "hangul"))
(define generic-on-key? (make-key-predicate '("<Shift> " "hangul")))
(define generic-off-key '("<Shift> " "hangul"))
(define generic-off-key? (make-key-predicate '("<Shift> " "hangul")))
